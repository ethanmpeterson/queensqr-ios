...
class ServiceListViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if (indexPath.section == 0) {
            ...
            print(rowSelected)
            performSegue(withIdentifier: "serviceView", sender: self)
        }
    }
...
//    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0 {
            ...
            cell.textLabel?.text = service["name"] as! String
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.destination is ServiceViewController {
            let dest = segue.destination as! ServiceViewController
            dest.service = services![rowSelected]
        }
    }
